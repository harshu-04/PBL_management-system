...
Bash
git clone https://github.com/harshu-04/PBL_management-system.git
...
cd backend
npm install
Create a .env file based on .env.example and add your MONGO_URI, JWT_SECRET, and CLOUDINARY keys.
